...
## Hoisting: 
concepto que trata sobre como un programa puede verse afectado por el orden de la creacion y la ejecucion del codigo.
...
- **while** : Ejecuta en bucle uno bloque de codigo siempre y cuando la condicion sea *True*, el pogramara no seguira su flujo hasta que la condicion sea *false*:
```javascript
    let numero = 0;
    while(numero<10){
...
- **Metodos**: funcionalidades o metodos: encender, apagar, acelerar...
